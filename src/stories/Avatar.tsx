...
export interface AvatarProps {
  ...
  /** An optional image to appear for an avatar */ image?: { src: string };
  /** Determine if the avatar is circular or square */ shape: 'circle' | 'square';
  /** The size of the avatar */ size: 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl';
}
